				...
				<motion.div
					...
					{modal.type === 'success' &&
						<div className='flex flex-col items-center justify-between h-full w-full text-center'>
							<h4 className='text-2xl'>Ваша заявка успешно отправлена!</h4>
							<IoCheckmarkCircleSharp className='text-5xl text-secondary-200'/>
							<p className='text-lg text-secondary-200'>Я обязательно свяжусь с Bами, ожидайте письма на ваш <b>Email: {modal.text}</b></p>
						</div>
					}
					...
					{modal.type === 'error' &&
						<div className='flex flex-col items-center justify-between h-full w-full text-center'>
							...
							<p className='text-lg text-secondary-200'>Проверьте Ваш почтовый ящик если в течении часа Вы не получите письмо, отправьте заявку повторно.</p>
						</div>
					}
				</motion.div>
				<button 
